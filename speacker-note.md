...
そこで今回は、ESLint というツールを使用して、静的解析により CDK のセオリーやベストプラクティスを検出することを目指します。  

ESLint とは JavaScript / TypeScript の Linter で、一貫性のあるコードを書くためだったり、コードの品質や安全性を高めることを目的として使用されます
