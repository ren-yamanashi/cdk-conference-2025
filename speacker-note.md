...
CDK においては、どのようなコードが品質の良いコードとされるかという、Tips だったりセオリーやベストプラクティスみたいなものは結構世の中に出ていて、最近だと AWS Summit で後藤さんがお話しされていた中にも、そのような内容が一部含まれていました。
一方で、このようなセオリーに違反しないコードを書く。というは、特に CDK を熟知していない開発者にとっては、そのセオリーを知っているかに左右される場合もあります。
