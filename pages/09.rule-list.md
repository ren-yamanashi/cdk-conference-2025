...
.highlighted-table tr:not(:nth-child(3)):not(:nth-child(8)) {
  opacity: 0.3;
}
...
参照: https://eslint-cdk-plugin.dev/ja/rules/ (v.3.1.0)
...
<!--
続いては、実際にデモなどを交えつつ、この Plugin の機能の一部を紹介したいと思います。

この Plugin には様々なルールが含まれているのですが、今回は時間も限られていますので、[click] その中から抜粋して2つ紹介いたします
-->
